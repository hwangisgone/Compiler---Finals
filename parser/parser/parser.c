...
ConstantValue* compileConstant(void) {
	...
	case SB_PLUS:
		...
		// ✔️ TODO: Check if type of the constant is integer
		// Note: Nonexist in other ver
	...
	case SB_MINUS:
		...
		constValue = compileConstant2();
		// ✔️ TODO: Check if type of the constant is integer
		// Note: Check is nonexist in other ver
		if (constValue->type != TP_INT) {
			error(ERR_TYPE_INCONSISTENCY, currentToken->lineNo, currentToken->colNo);
		}
...
Type* compileLValue(void) {
	// ✔️ TODO: parse a lvalue (a variable, an array element, a parameter, the current function identifier)
	Object* var;
	Type* varType = NULL;
...
void compileAssignSt(void) {
	Type* varType;
	Type* expType;
	// ✔️ TODO: parse the assignment and check type consistency
...
void compileForSt(void) {
	// ✔️ TODO: Check type consistency of FOR's variable
	// . var, exp1, exp2 must be the same
	Object* var;
	Type* exp1Type;
	Type* exp2Type;
...
// 	checkBasicType(var->varAttrs->type);
	...
	checkTypeEquality(exp1Type, var->varAttrs->type);
...
void compileArgument(Object* param) {
	// ✔️ TODO: parse an argument, and check type consistency
...
void compileArguments(ObjectNode* paramList) {
	// ✔️ TODO: parse a list of arguments, check the consistency of the arguments and the given parameters
...
void compileCondition(void) {
	// ✔️ TODO: check the type consistency of LHS and RSH, check the basic type
	Type* exp1Type;
	Type* exp2Type;
